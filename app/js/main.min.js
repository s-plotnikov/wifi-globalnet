...
$(document).ready((function() {
    if ($(".js-aside").length) {
        ...
        document.querySelector(".js-aside").insertAdjacentHTML("afterbegin", tpl.replace("{{contents}}", contents));
        window.addEventListener("scroll", (() => {
            ...
            if (headerId) {
                document.querySelector(`a[href$="#${headerId}"]`).classList.add("__current");
            }
        }));
    }
}));
